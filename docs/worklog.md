...
### 2026-07 · Step 1 — First real run (Kaggle). Negative result.
...
### 2026-07 · Step 4 — Performance rescope.
...
### 2026-07 · Step 1 — Design mismatch found.
...
### 2026-07 · Step 2 — Realign to train-on-source / test-on-target.
...
### 2026-07 · Step 3 — Zero-shot run. Flatline.
...
### 2026-07 · Step 4 — Planned: linear-probe on target ("minimal changes").
